...
- 2026-09-01 — 📈 **V3.8** — 3축 평균 **73.74** 로 **자체 최고치** (V3.7 73.48 대비 **+0.26p**) · 표 **48.84** (+0.83p) · 머리말 **95.96** (+0.76p). 채택은 `final` 이 아니라 **`checkpoint-10500`** 이다. 본문은 76.41 로 1.31p 더 내렸다 — 표를 얻고 본문을 내주는 교환이 V3.7 에 이어 반복됐다
...
| **2** | **Ours** | **0.99B** | 95.96 | 76.41 | 48.84 | 73.74 |
...
```bash
# 벤치마크 최고점 경로(849쪽 3축 73.74 를 낸 조합)
