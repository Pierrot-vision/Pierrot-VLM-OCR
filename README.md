...
- 2026-09-04 — 🏆 **KDoc-OCRBench-V2 세 축 모두 1위** — 3축 **78.37** · 머리말 **97.47** — 외부 검출기 [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3) **(PP)** 로 머리말·꼬리말 필터링
...
|---:|---|---:|---:|---:|---:|---:|
| **1** | **Ours + PP** | 0.99B + 검출기 | **97.47** | 79.36 | **58.27** | **78.37** |
...
```bash
# 벤치마크 최고점 경로(849쪽 3축 78.04 를 낸 조합)
