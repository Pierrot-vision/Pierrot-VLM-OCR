...
- 2026-08-24 — 📈 **V3.6** — 3축 평균 **73.36** (V3.5 71.86 대비 **+1.50p**) · **세 축 모두 상승** — 표 **46.51** (+2.41p) · 머리말 **95.08** (+1.65p) · 본문(Long Text) **78.49** (+0.45p). 2위·본문 전체 1위는 그대로 유지
...
| **2** | **Ours** | **0.99B** | 95.08 | **78.49** | 46.51 | 73.36 |
