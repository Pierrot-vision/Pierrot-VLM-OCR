...
- 2026-08-24 — 📈 **V3.6** — 3축 평균 **73.13** (V3.5 71.86 대비 **+1.27p**) · **세 축 모두 상승** — 본문(Long Text) **79.33** (+1.29p) · 표 **45.12** (+1.02p) · 머리말 **94.95** (+1.52p). 2위·본문 전체 1위는 그대로 유지
...
| **2** | **Ours** | **0.99B** | 94.95 | **79.33** | 45.12 | 73.13 |
