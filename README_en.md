...
- 2026-09-04 — 📈 **KDoc-OCRBench-V2 3-axis 78.37** — header/footer filtered with PP-DocLayoutV3, **97.47 — 1st on all three axes**
...
```bash
# the best benchmark path (the combination that produced 78.37 over 849 pages)
