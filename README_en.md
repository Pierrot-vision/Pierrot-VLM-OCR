...
- 2026-08-24 — 📈 **V3.6** — 3-axis mean **73.36** (**+1.50p** over V3.5's 71.86) · **all three axes up** — Table **46.51** (+2.41p) · Header/Footer **95.08** (+1.65p) · Long Text **78.49** (+0.45p). Still 2nd overall and 1st on Long Text
