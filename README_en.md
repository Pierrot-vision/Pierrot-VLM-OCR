...
- 2026-09-04 — 🏆 **KDoc-OCRBench-V2 1st on all three axes** — 3-axis **78.37** · Header/Footer **97.47** — header/footer filtered with the external [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3)
...
|---:|---|---:|---:|---:|---:|---:|
| **1** | **Ours + [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3)** | 0.99B + detector | **97.47** | 79.36 | **58.27** | **78.37** |
