...
- 2026-09-04 — 🔬 **Header/Footer 97.47** — **reference** figure with header/footer filtered by the external [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3) (3-axis 78.37). Our standalone model, 78.04, remains the headline
...
| — | *reference — Ours + external [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3)* | 0.99B + detector | *97.47* | *79.36* | *58.27* | *78.37* |
