...
- 2026-09-04 — 🏆 **KDoc-OCRBench-V2 1st on all three axes** — 3-axis **78.37** · Header/Footer **97.47** — header/footer filtered with the external [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3) **(PP)**
- 2026-09-03 — 🏆 **[KDoc-OCRBench-V2](https://huggingface.co/datasets/ONTHEIT/KDoc-OCRBench-V2) 1st** — 3-axis **78.04** (BizOnAI 76.90) · Long Text **79.63** · Table **58.27** — [scoring](LAB/pierrotocrvlm/pierrotocrvlm.md#채점-기준을-두-가지로-쓰는-이유)
...
|---:|---|---:|---:|---:|---:|---:|
| **1** | **Ours + PP** | 0.99B + detector | **97.47** | 79.36 | **58.27** | **78.37** |
| **2** | **Ours** | **0.99B** | 96.21 | **79.63** | **58.27** | 78.04 |
| 3 | BizOnAI-OCR *(commercial)* | undisclosed | 94.70 | 77.90 | 58.10 | 76.90 |
| 4 | PaddleOCR-VL | 0.9B | 95.60 | 66.20 | 48.90 | 70.20 |
| 5 | DeepSeek OCR | ~3B *(MoE, 0.57B active)* | 95.80 | 64.50 | 46.60 | 69.00 |
...
![two-column document parsing demo](https://github.com/Pierrot-vision/Pierrot-VLM-OCR/releases/download/v0.2.0/demo_paper.gif)

**Single-column document**

![single-column document parsing demo](https://github.com/Pierrot-vision/Pierrot-VLM-OCR/releases/download/v0.2.0/demo_kdi.gif)
...
```bash
# the best benchmark path (the combination that produced 78.04 over 849 pages)
