...
- 2026-09-03 — 🏆 **[KDoc-OCRBench-V2](https://huggingface.co/datasets/ONTHEIT/KDoc-OCRBench-V2) 1st** — 3-axis **78.00** (BizOnAI 76.90) · Long Text **79.63** · Table **58.27** — [scoring](LAB/pierrotocrvlm/pierrotocrvlm.md#채점-기준을-두-가지로-쓰는-이유)
...
```bash
# the best benchmark path (the combination that produced 78.00 over 849 pages)
