...
**3축 평균 78.00**(상용 1위를 +1.10p 앞선 단독 1위)까지 올린 기록이다. 성공한 것뿐 아니라 **실패한 가설과 계측 실수**도
...
|---:|---|---:|---:|---:|---:|---|
| **1** | **V3.8 s10500 @4MP + 초보수HF** ★채택 | 96.09 | 79.63 | 58.27 | **78.00** | 공백+규약 무시 |
| 2 | V3.8 s10500 @본문4MP + 초보수HF | 96.09 | 79.54 | **58.34** | 77.99 | 공백+규약 무시 |
| 3 | V3.8 s10500 @4MP + 안전HF | 95.83 | 79.75 | 58.27 | 77.95 | 공백+규약 무시 |
| 4 | V3.8 s10500 @본문4MP + 안전HF | 95.83 | 79.65 | **58.34** | 77.94 | 공백+규약 무시 |
| 5 | V3.8 s10500 @4MP | 95.71 | **79.76** | 58.27 | 77.91 | 공백+규약 무시 |
| 5 | V3.8 s10500 @본문4MP | 95.71 | 79.67 | **58.34** | 77.91 | 공백+규약 무시 |
| 7 | V3.8 s10500 @2MP + 초보수HF | 96.34 | 76.30 | 58.32 | 76.98 | 공백+규약 무시 |
| 8 | V3.8 s10500 @2MP + 안전HF | 96.09 | 76.39 | 58.32 | 76.93 | 공백+규약 무시 |
| 9 | V3.8 s10500 @2MP | 95.96 | 76.41 | 58.32 | 76.90 | 공백+규약 무시 |
| 9 | BizOnAI-OCR | 94.70 | 77.90 | 58.10 | 76.90 | 정식 |
| 11 | V3.8 final @2MP | 95.83 | 76.30 | 58.29 | 76.81 | 공백+규약 무시 |
| 12 | V3.7 s14000 @2MP | 95.20 | 77.23 | 57.97 | 76.80 | 공백+규약 무시 |
| 13 | V3.9 s15000 @2MP | 95.58 | 76.72 | 57.36 | 76.55 | 공백+규약 무시 |
| 14 | V3.9 s13000 @2MP | 95.83 | 75.64 | 58.13 | 76.54 | 공백+규약 무시 |
| 15 | V3.7 s13000 @2MP | 95.45 | 76.65 | 57.13 | 76.41 | 공백+규약 무시 |
| 16 | V3.8 s10500 @본문4MP + 안전HF | 95.83 | 79.65 | 48.86 | 74.78 | 공백무시 |
| 17 | V3.8 s10500 @4MP + 안전HF | 95.83 | 79.75 | 48.49 | 74.69 | 공백무시 |
...
**최종 파이프라인** — `추론(4MP) → 회전 보정 → edge60 → 초보수HF → lead`.
...
났고, 더 좁히자 더 올랐다. 세 해상도에서 방향과 크기가 같다.

| 해상도 | 후처리 | Header/Footer | Long Text | Table | 3축 |
|---|---|---:|---:|---:|---:|
| 2MP | 없음 | 95.96 | 76.41 | 58.32 | 76.90 |
| 2MP | 안전HF | 96.09 | 76.39 | 58.32 | 76.93 |
| 2MP | **초보수HF** | **96.34** | 76.30 | 58.32 | **76.98** |
| 4MP | 없음 | 95.71 | **79.76** | 58.27 | 77.91 |
| 4MP | 안전HF | 95.83 | 79.75 | 58.27 | 77.95 |
| 4MP | **초보수HF** | **96.09** | 79.63 | 58.27 | **78.00** |
| 본문4MP | 없음 | 95.71 | 79.67 | **58.34** | 77.91 |
| 본문4MP | 안전HF | 95.83 | 79.65 | **58.34** | 77.94 |
| 본문4MP | **초보수HF** | **96.09** | 79.54 | **58.34** | 77.99 |

| | 머리말 | 본문 | 표 | 3축 |
|---|---:|---:|---:|---:|
| 안전HF | +0.12 ~ +0.13 | −0.01 ~ −0.02 | 불변 | **+0.03 ~ +0.04** |
| 초보수HF | **+0.26 ~ +0.38** | −0.11 ~ −0.13 | 불변 | **+0.05 ~ +0.09** |
...
방법이 아니라 범위**다 — 넓게 지우면 본문을 그보다 많이 잃는다.

⚠ 폭이 작다(3축 +0.05~0.09p). 판정은 여전히 점추정이고 부트스트랩 CI 는 재지 않았다
(§10 결함 14).
...
| Header/Footer 는 후처리로 올릴 수 있다 | **5가지 전부 3축을 깎았다.** 평가셋 정답을 직접 보고 지우는 oracle 조차 +0.58p 다. 단 **지우는 범위를 좁히면 순증**한다 — 안전HF +0.03~0.04p · 초보수HF **+0.05~0.09p**(§8) |
