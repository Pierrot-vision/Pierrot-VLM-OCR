...
**3축 평균 73.41** 까지 올린 기록이다. 성공한 것뿐 아니라 **실패한 가설과 계측 실수**도
...
| **2** | **V3.6 + 밴드 + body_fill** | 95.08 | **78.54** | 46.60 | **73.41** | 공백무시 |
| 3 | V3.5 + 밴드 + body_fill | 93.43 | 78.04 | 44.10 | 71.86 | 공백무시 |
| 4 | V3.0 + 밴드 + body_fill | 96.09 | 76.61 | 42.70 | 71.80 | 공백무시 |
| 5 | V3.0 + body_fill | 96.72 | 74.74 | 42.42 | 71.29 | 공백무시 |
| 6 | PaddleOCR-VL | 95.60 | 66.20 | 48.90 | 70.20 | 정식 |
| 7 | DeepSeek OCR | 95.80 | 64.50 | 46.60 | 69.00 | 정식 |
| 8 | V3.4t s1500 | 95.83 | 64.15 | 45.66 | 68.55 | 공백무시 |
| 9 | V3.4t s500 | 96.72 | 64.88 | 43.98 | 68.52 | 공백무시 |
| 10 | olmOCR v0.2.0 | 95.20 | 65.00 | 44.90 | 68.40 | 정식 |
| 11 | V3.5 final (조립 없음) | 93.94 | 64.67 | 44.07 | 67.56 | 공백무시 |
| 12 | V3.0 (조립 없음) | 96.97 | 62.93 | 42.42 | 67.44 | 공백무시 |
| 13 | GLM-4.1V-OCR | **97.40** | 52.90 | 30.00 | 60.10 | 정식 |
...
★ **본문(Long Text)은 78.54 로 1위다**(BizOnAI 77.90). 남은 격차는 **표 하나**다
(46.60 vs 58.10).

★ **V3.6 이 처음으로 세 축을 동시에 올렸다.** V3.5 대비 표 **+2.50p** · 머리말 **+1.65p** ·
본문 **+0.50p**, 3축 **+1.55p**. 그 전까지는 한 축을 내주고 다른 축을 얻는 교환이었다 —
V3.5 는 본문·표를 얻는 대신 머리말을 93.43 까지 내줬는데, V3.6 이 95.08 로 되돌렸다
(V3.0 의 96.09 에는 아직 못 미친다).
