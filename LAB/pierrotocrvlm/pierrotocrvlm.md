...
**3축 평균 77.91**(상용 1위를 +1.01p 앞선 단독 1위)까지 올린 기록이다. 성공한 것뿐 아니라 **실패한 가설과 계측 실수**도
...
|---:|---|---:|---:|---:|---:|---|
| **1** | **V3.8 s10500 + 회전 + edge60 + 본문 4MP** ★채택 | 95.71 | **79.67** | **58.34** | **77.91** | 공백+머리글규약 무시 |
| 2 | BizOnAI-OCR | 94.70 | 77.90 | 58.10 | 76.90 | 정식 |
| 2 | V3.8 s10500 + 회전 + edge60 (2MP) | **95.96** | 76.41 | 58.32 | 76.90 | 공백+머리글규약 무시 |
| 4 | V3.8 final | 95.83 | 76.30 | 58.29 | 76.81 | 공백+머리글규약 무시 |
| 5 | V3.7 s14000 | 95.20 | 77.23 | 57.97 | 76.80 | 공백+머리글규약 무시 |
| 6 | V3.9 s15000 | 95.58 | 76.72 | 57.36 | 76.55 | 공백+머리글규약 무시 |
| 7 | V3.9 s13000 | 95.83 | 75.64 | 58.13 | 76.54 | 공백+머리글규약 무시 |
| 8 | V3.7 s13000 | 95.45 | 76.65 | 57.13 | 76.41 | 공백+머리글규약 무시 |
...
### 학습셋 형식과 평가셋 형식이 다르다 — 채점 기준을 두 가지로 쓰는 이유

우리 학습 정답과 KDoc 평가셋은 **같은 표를 다르게 적는다.** 모델은 자기가 배운 형식을
정확히 재현하는데(아래 근거 ①), 채점기는 평가셋 형식을 기대하므로 그 차이가 통째로
오답으로 집계된다. **읽기 능력이 아니라 표기 규약의 문제**다.
...
| Header/Footer 는 후처리로 올릴 수 있다 | **5가지 전부 3축을 깎았다.** 평가셋 정답을 직접 보고 지우는 oracle 조차 +0.58p 이고, 4MP(77.91)가 그 oracle(77.48)을 이미 넘었다 |
